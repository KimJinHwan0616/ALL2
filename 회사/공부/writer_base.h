 ...
 * @class WriterBase
 * 
 * @brief Writer는 메시지를 'Channel'을 통해 전송하는 객체입니다.
 * 
 * @warning 하나의 Writer는 하나의 채널만 작성할 수 있습니다.
 * 하지만 다른 writer들은 동일한 채널을 통해 작성할 수 있습니다.
 */
class WriterBase {
 public:
  /**
  ...
  /**
   * @brief 우리가 작성하는 channel을 구독하는 모든 Readers를 가져옵니다.
   *
